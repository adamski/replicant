...
use replicant_core::protocol::{ChangeEvent, ChangeEventType};
use replicant_core::{SyncError, SyncResult};
...
impl ServerDatabase {
    ...
    pub async fn update_document_in_tx(
        ...
        let reverse_patch_json = if let Some(fwd_patch) = patch {
            ...
            match replicant_core::patches::compute_reverse_patch(&original_doc.content, fwd_patch) {
