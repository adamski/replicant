...
#[tokio::main]
async fn main() -> replicant_core::SyncResult<()> {
...
async fn generate_credentials(name: &str) -> replicant_core::SyncResult<()> {
    use colored::*;
